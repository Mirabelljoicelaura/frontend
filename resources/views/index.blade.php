            ...
            <div class="order-2 md:order-3 flex items-center" id="nav-content">
                <nav>
                    <ul class="md:flex items-center justify-between text-base text-gray-700 pt-4 md:pt-0">
                        ...
                        <li><a class="inline-block no-underline hover:text-black hover:underline py-2 px-4" href="#">Potensi</a></li>
                        <li><a class="inline-block no-underline hover:text-black hover:underline py-2 px-4" href="#">Ormas</a></li>
                        <li><a class="inline-block no-underline hover:text-black hover:underline py-2 px-4" href="#">Galeri</a></li>
                    </ul>
                </nav>
        </div>
    </nav>
