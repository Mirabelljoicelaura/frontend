<nav id="header" class="w-full z-30 top-0 sticky">
            ...
            <nav>
                <ul class="md:flex items-center justify-between text-base text-gray-700 pt-4 md:pt-0">
                    ...
                    <li class="relative" x-data="{dropdownOpen:false}">
                        <button class="inline-block hover:text-gray-800 py-2 px-4 text-white" href="#" onclick="myFunction('myDropdown')">Profile
                    ...
                    <li><a class="inline-block no-underline hover:text-gray-800 py-2 px-4 text-white" href="#">Galeri</a></li>
                    <li><a class="inline-block no-underline hover:text-gray-800 py-2 px-4 text-white" href="#">Contact Us</a></li>
                </ul>
            </nav>
        </div>
    </div>
